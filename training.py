...
class LunaTrainingApp:
    def __init__(self, sys_argv=None):
        ...
        def initOptimizer(self):
            return SGD(self.model.parameters(), lr=0.001, momentum=.99)
        ...
        def logMetrics(self,
            ...
            if negHist_mask.any():
                writer.add_histogram('is_neg',
                                    metrics_t[METRICS_PRED_NDX, negHist_mask],
                                    self.totalTrainingSamples_count,
                                    bins = bins)
            
            if posHist_mask.any():
                writer.add_histogram('is_pos',
